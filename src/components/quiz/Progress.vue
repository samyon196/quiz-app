<template>
    <div>
        <div v-if="isAnswered">
            <strike>Question <b>{{currentQuestion+1}}/{{num_questions}}</b></strike> <span style="font-size: 0.7em"> ({{realIndex+1}})</span>
        </div>
        <div v-else>
            Question <b>{{currentQuestion+1}}/{{num_questions}}</b> <span style="font-size: 0.7em"> ({{realIndex+1}})</span>
        </div>
